...
The parameter list is nothing more than a sequence of variable declarations (variable declaration and assignment are described in \ref{}) separated by semicolons, the initialization syntax being used to define a default value, making the parameter optional: in \id{my\_print}, the parameter \id{s} has the empty string as its default value.
