...
\section{Expressions}
    ...
    \subsection{Any expression}
        ...
        \begin{bnf*}
            ...
            \bnfprod{mult-expr-aux}{\bnfpn{mult-op}\bnfpn{mult-expr-aux} \bnfor \bnfpn{mult-op}\bnfpn{exp-expr}\bnfpn{mult-expr-aux}}\\
            \bnfprod{exp-expr}{\bnfpn{cast-expr} \bnfor \bnfpn{cast-expr}\bnfpn{exp-expr-aux}}\\
            \bnfprod{exp-expr-aux}{\bnfpn{exp-op}\bnfpn{exp-expr-aux} \bnfor \bnfpn{exp-op}\bnfpn{cast-expr}\bnfpn{exp-expr-aux}}\\
