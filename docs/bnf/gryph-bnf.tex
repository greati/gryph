...
\section{Control Structures}
    ...
    \begin{bnf*}
        \bnfprod{iteration-stmt}{\bnfpn{for-loop} \bnfor \bnfpn{while-loop}}\\
        \bnfprod{while-loop}{\bnfts{while}\bnfpn{expression}\bnfpn{block-or-matched}}\\
        \bnfprod{for-loop}{\bnfts{for}\bnfpn{id-list}\bnfts{over}\bnfpn{id-list}\bnfpn{block-or-matched}}\\
    \end{bnf*}
