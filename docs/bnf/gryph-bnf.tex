...
\section{General structure}
    ...
    \begin{bnf*}
        ...
        \bnfprod{matched-list}{\bnfpn{matched-stmt} \bnfsp \bnfts{;} \bnfor \bnfpn{matched-stmt}\bnfsp\bnfts{;}\bnfsp\bnfpn{matched-list}}\\
        \bnfprod{unmatched-list}{\bnfpn{unmatched-stmt} \bnfsp \bnfts{;} \bnfor \bnfpn{unmatched-stmt}\bnfsp\bnfts{;}\bnfsp\bnfpn{unmatched-list}}\\
        \bnfprod{stmt-block}{\bnfts{\{} \bnfsp \bnfpn{stmt-list} \bnfsp \bnfts{\}} \bnfor \bnfpn{stmt} \bnfsp \bnfts{;}}\\
        \bnfprod{matched-block}{\bnfts{\{} \bnfsp \bnfpn{matched-list} \bnfsp \bnfts{\}} \bnfor \bnfpn{matched-stmt} \bnfsp \bnfts{;}}\\        
        \bnfprod{unmatched-block}{\bnfts{\{} \bnfsp \bnfpn{unmatched-list} \bnfsp \bnfts{\}} \bnfor \bnfpn{unmatched-stmt} \bnfsp \bnfts{;}}\\
...
\section{Control Structures}
    \subsection{If-else statements}
        \begin{bnf*}
        \bnfprod    {matched-if}{\bnfts{if} \bnfsp \bnfts{(}\bnfpn{b-exp}\bnfts{)} \bnfsp \bnfpn{matched-block}}\\
        \bnfprod{matched-if-else}{\bnfpn{matched-if} \bnfsp \bnfts{else} \bnfsp \bnfpn{matched-block}}\\
        \bnfprod{unmatched-if-else}{\bnfpn{matched-if} \bnfsp \bnfts{else} \bnfsp \bnfpn{unmatched-block}}\\
        \bnfprod{if-stmt}{\bnfts{if} \bnfsp \bnfts{(}\bnfpn{b-exp}\bnfts{)} \bnfsp \bnfpn{stmt-block}}\\
        \end{bnf*}
...
\section{Expressions}
    ...
    \subsection{Relational expressions}
        \begin{bnf*}
            ...
            \bnfprod{rel-term}{\bnfpn{any-expr}}\\
        \end{bnf*}
